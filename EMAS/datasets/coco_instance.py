...
class COCOInstance(LightningDataModule):
    ...
    def setup(self, stage: Union[str, None] = None) -> LightningDataModule:
        ...
        # --- MODIFICA: Usiamo val2017 anche per il train_dataset --- per noi val2017 vine usato come fonte di anomalie qindi diventa train2017
        self.train_dataset = Dataset(
            transforms=self.transforms,
            # Percorso dentro lo zip: usiamo la cartella train
            img_folder_path_in_zip=Path("./val2017"), 
            # JSON Annotazioni: usiamo quello di val
            ...
            # File zip fisico: usiamo val2017.zip -> rinominato train2017.zip
            zip_path=Path(self.path, "train2017.zip"), 
            **dataset_kwargs,
        )
        
        # Il val_dataset rimane invariato (era già corretto)
